...
export default function MainChat() {
  ...
  return (
    <div className="flex h-[780px] w-[380px] flex-col items-center rounded-3xl border-4 border-[#6b705c] bg-[#f9f7f3] bg-opacity-70 shadow-lg">
      <div className="my-3 flex w-32 items-center justify-center gap-10 rounded-full bg-neutral-800 px-4 py-1">
        <div className="h-3 w-3 animate-fade-in-out rounded-full bg-red-500"></div>
